variable "credentials" {
  ...
  # Path to your Service Account json file.  if you do not want to use this 
  # then another option is to set env variable GOOGLE_APPLICATION_CREDENTIALS 
...
variable "bq_dataset_name" {
  ...
  default     = "week_2_hw_dataset_jschuller"
}

variable "gcs_bucket_name" {
  description = "Storage Bucket Name for Week-1 Homework"
  #Update the below to a unique bucket name
  default     = "week-2-hw-bucket-jschuller"
}
